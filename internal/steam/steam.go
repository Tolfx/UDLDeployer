...
// SteamClient is a struct that holds the API key and provides methods to interact with the Steam API.
...
func (client *SteamClient) DeleteAccount(steamID string) (err error) {
	params := make(map[string]string)
